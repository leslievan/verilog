...
LAB84:    memcpy(t12, t105, 8);

LAB85:    t106 = (t0 + 2568);
    xsi_vlogvar_assign_value(t106, t12, 0, 0, 1);
...
LAB113:    if (*((unsigned int *)t96) > 0)
        goto LAB114;

LAB115:    if (*((unsigned int *)t13) > 0)
        goto LAB116;

LAB117:    memcpy(t12, t105, 8);

LAB118:    t106 = (t0 + 2888);
    xsi_vlogvar_assign_value(t106, t12, 0, 0, 2);
    goto LAB29;
...
LAB138:    t30 = (t0 + 2888);
    xsi_vlogvar_assign_value(t30, t12, 0, 0, 2);
    goto LAB29;
...
LAB77:    t100 = ((char*)((ng17)));
    goto LAB78;

LAB79:    t105 = ((char*)((ng18)));
    goto LAB80;

LAB81:    xsi_vlog_unsigned_bit_combine(t12, 32, t100, 32, t105, 32);
    goto LAB85;

LAB83:    memcpy(t12, t100, 8);
    goto LAB85;

LAB86:    *((unsigned int *)t14) = 1;
    goto LAB89;

LAB91:    t23 = *((unsigned int *)t14);
    t24 = *((unsigned int *)t11);
    *((unsigned int *)t14) = (t23 | t24);
    t25 = *((unsigned int *)t10);
    t26 = *((unsigned int *)t11);
...
LAB110:    t100 = ((char*)((ng1)));
    goto LAB111;

LAB112:    t105 = ((char*)((ng8)));
    goto LAB113;

LAB114:    xsi_vlog_unsigned_bit_combine(t12, 2, t100, 2, t105, 2);
    goto LAB118;

LAB116:    memcpy(t12, t100, 8);
    goto LAB118;
...
extern void work_m_00000000003542674115_1859292485_init()
{
	...
	xsi_register_didat("work_m_00000000003542674115_1859292485", "isim/Translate_Control_T_isim_beh.exe.sim/work/m_00000000003542674115_1859292485.didat");
